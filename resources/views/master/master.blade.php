...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @endif
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            @if (Session::has('username'))
                ...
                <ul class="flex flex-col p-2 pt-3 mt-5 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                    <a href="settings" class="block py-2 pr-4 pl-3 pt-3 text-gray-700 rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Settings</a>
                    </li>
                    <li>
                    <a href="logout" class="block py-2 pr-4 pl-3 pt-3 text-gray-700 rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Logout</a>
                    </li>
                    <li>
                        <!-- Dark mode switcher -->
                            <button
        ...
        <div class="flex px-6 py-3 font-sans text-gray-900 antialiased">
            <div class="">
                @if (Session::has('username'))
